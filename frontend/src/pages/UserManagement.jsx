  ...
  const cls =
      role === 'ADMIN' ? 'bg-purple-100 text-purple-700' :
          role === 'INSTRUCTOR' ? 'bg-blue-100 text-blue-700' :
              role === 'CANDIDATE' ? 'bg-emerald-100 text-emerald-700' :
        ...
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full">
          ...
          <form onSubmit={handleSubmit} noValidate className="p-5 space-y-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-800 mb-1.5">Prezime</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-800 mb-1.5">Lozinka</label>
